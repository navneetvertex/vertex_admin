...
export class DistrictComponent implements OnInit {
  ...
  constructor(private masterService: MastersService,
    ...
    ngOnInit(): void {
      this.breadCrumbItems = [{ label: 'Master' }, { label: this.title, active: true }];
    ...
    onSubmit() {
      if (this.addFormGroup.valid) {
        this.masterService.createDistrict(this.addFormGroup.value).subscribe({
          next: (response: any) => {
    ...
    onEdit() {
      if (this.editFormGroup.valid) {
        ...
        this.masterService.updateDistrict(this.editFormGroup.value._id, this.editFormGroup.value).subscribe({
          next: (response: any) => {
    ...
    getList() {
      this.masterService.getDistricts(this.page, this.pageSize).subscribe({
        next: (response: any) => {
